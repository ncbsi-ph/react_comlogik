  ...
  return (
    <Section>
      ...
      <Grid childWidth="1-1">
        ...
        <Column>
          <div
            className="uk-child-width-1-1 uk-child-width-1-2@s uk-child-width-1-3@l"
            data-uk-grid=""
            data-uk-scrollspy="cls: uk-animation-scale-up; target: > div; delay:500; repeat: false"
          >
            <Advantage
            ...
            <Advantage
              ...
              description="Lifetime Software Warranty enables you to use the software as long as you want and not worry of having to pay extra for maintenance or additional cost on support and after sales services. The longer you use our software the more it pays off."
              number="8"
            />
            <Advantage
              icon="static/advantage-9.svg"
              advantage="Backwards Compatibility"
              description="By allowing you to make use of your existing computers and OS but still interoperable with the latest increases the value of your investment since you don’t need to purchase additional units and reconfigure everything just to run the new system."
              number="9"
            />
          </div>
        </Column>
