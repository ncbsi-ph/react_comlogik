      ...
      <div>
        <div data-uk-grid>
          ...
          <div className="uk-width-expand uk-flex uk-flex-column">
            <h5 className="uk-margin-remove-bottom">{this.props.advantage}</h5>
        ...
        <div className="uk-container">
          <div className="uk-child-width-1-1" data-uk-grid>
            <div className="uk-flex uk-flex-center uk-flex-column">
              <h5 className="uk-text-center">ADVANTAGES</h5>
              <h1 className="uk-text-center">Why choose us?</h1>
              <p className="uk-text-center">
                Unbeatable Advantages Over Any Provider
              </p>
            </div>
            <div>
