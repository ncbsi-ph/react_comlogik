            ...
            <Column>
              <div>
                <div className="uk-card-body">
                  ...
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Cras felis massa, condimentum sit amet dignissim et, ornare
                    a metus. Nullam leo leo, euismod vehicula massa eget,
                    bibendum hendrerit diam. Fusce vel velit aliquet, molestie
                    sapien pharetra, tempus ante.{' '}
                    <a className="link uk-text-bold">Read more</a>
                  </p>
                </div>
              </div>
            </Column>
